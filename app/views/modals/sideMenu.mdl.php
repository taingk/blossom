    ...
    <ul class="backMenu">
        <li class="backMenuLink banner row">
            <div class="col-xs-10 is-h-centered">
                <a href="/back/dashboard"><div class="profile-picture is-h-centered bg-is-pink"><?php echo $aConfigs['profiles']['sName'] ?></div></a>
                <p><a href="/back/users/update?id=<?php echo $_SESSION['id_user'] ?>" class="is-white"><?php echo $aConfigs['profiles']['fName'] ?> <?php echo $aConfigs['profiles']['lName'] ?></a></p>
        ...
        foreach ($aConfigs as $sKey => $aValue):
            ...
            <?php else: ?> 
                <li class="backMenuLink row" id="<?php echo $sKey ?>" onClick="openCustomization()">
                    ...
                    <a class="is-v-centered is-black" style="cursor: pointer; padding: 0 20px;"><?php echo $aMenu['title'] ?></a>
                    <ul id="submenu">
