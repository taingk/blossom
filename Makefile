...
pull:
	git pull && cp ../config/conf.inc.php app/conf.inc.php && cp ../config/Makefile . && cp ../config/PhpmailerController.class.php app/controllers/modules/ cp ../config/.htaccess .
